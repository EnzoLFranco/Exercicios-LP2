...
public class multiplicacao {
    ...
    public void multiplicacaoFracoes() {
        System.out.print("Quantas frações você pretende multiplicar? ");
        ...
        System.out.println("A fração final da multiplicação é: " + numeradorFinal + "/" + denominadorFinal);
    }
}
